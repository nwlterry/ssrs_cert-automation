...
Write-Log "Starting SSRS Certificate Rebind Process (CN+SAN). EventRecordId: $EventRecordId" -Level Debug
...
Write-Log "Applying new certificate for the following names (CN/SAN): $($DnsNames -join ', ')" -Level Info
